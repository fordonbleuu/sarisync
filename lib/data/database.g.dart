...
class Sale extends DataClass implements Insertable<Sale> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, totalAmount, discount, paymentType, status, timestamp);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Sale &&
...
class $CashFlowLogsTable extends CashFlowLogs
    with TableInfo<$CashFlowLogsTable, CashFlowLog> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CashFlowLogsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'cash_flow_logs';
  @override
  VerificationContext validateIntegrity(
    Insertable<CashFlowLog> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  CashFlowLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CashFlowLog(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $CashFlowLogsTable createAlias(String alias) {
    return $CashFlowLogsTable(attachedDatabase, alias);
  }
}

class CashFlowLog extends DataClass implements Insertable<CashFlowLog> {
  final int id;
  final String type;
  final double amount;
  ...
  CashFlowLogsCompanion toCompanion(bool nullToAbsent) {
    return CashFlowLogsCompanion(
      id: Value(id),
      type: Value(type),
      amount: Value(amount),
  ...
  CashFlowLog copyWithCompanion(CashFlowLogsCompanion data) {
    return CashFlowLog(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('CashFlowLog(')
          ..write('id: $id, ')
          ..write('type: $type, ')
          ..write('amount: $amount, ')
  ...
  @override
  int get hashCode => Object.hash(id, type, amount, description, timestamp);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CashFlowLog &&
          other.id == this.id &&
...
class CashFlowLogsCompanion extends UpdateCompanion<CashFlowLog> {
  final Value<int> id;
  final Value<String> type;
  final Value<double> amount;
  final Value<String> description;
  final Value<DateTime> timestamp;
  const CashFlowLogsCompanion({
    this.id = const Value.absent(),
  ...
  CashFlowLogsCompanion.insert({
    ...
    this.timestamp = const Value.absent(),
       ...
       amount = Value(amount),
       description = Value(description);
  static Insertable<CashFlowLog> custom({
    Expression<int>? id,
  ...
  CashFlowLogsCompanion copyWith({
    Value<int>? id,
    Value<String>? type,
    Value<double>? amount,
  ...
  @override
  String toString() {
    return (StringBuffer('CashFlowLogsCompanion(')
          ..write('id: $id, ')
          ..write('type: $type, ')
          ..write('amount: $amount, ')
          ..write('description: $description, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CashFlowLogsTable cashFlowLogs = $CashFlowLogsTable(this);
  @override
...
class $$SalesTableTableManager
    extends
        RootTableManager<
          ...
          Sale,
          PrefetchHooks Function({bool saleItemsRefs, bool debtsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({saleItemsRefs = false, debtsRefs = false}) {
            return PrefetchHooks(
              db: db,
                ...
                return [
                  ...
                  if (debtsRefs)
                    await $_getPrefetchedData<Sale, $SalesTable, Debt>(
                      currentTable: table,
                      referencedTable: $$SalesTableReferences._debtsRefsTable(
                        db,
                      ),
                      managerFromTypedResult: (p0) =>
...
typedef $$DebtsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool saleId})
    >;
typedef $$CashFlowLogsTableCreateCompanionBuilder =
    CashFlowLogsCompanion Function({
      Value<int> id,
      required String type,
      required double amount,
      required String description,
...
typedef $$CashFlowLogsTableUpdateCompanionBuilder =
    CashFlowLogsCompanion Function({
      Value<int> id,
      Value<String> type,
      Value<double> amount,
...
class $$CashFlowLogsTableFilterComposer
    extends Composer<_$AppDatabase, $CashFlowLogsTable> {
  $$CashFlowLogsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CashFlowLogsTableOrderingComposer
    extends Composer<_$AppDatabase, $CashFlowLogsTable> {
  $$CashFlowLogsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CashFlowLogsTableAnnotationComposer
    extends Composer<_$AppDatabase, $CashFlowLogsTable> {
  $$CashFlowLogsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$CashFlowLogsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CashFlowLogsTable,
          ...
          $$CashFlowLogsTableOrderingComposer,
          $$CashFlowLogsTableAnnotationComposer,
          $$CashFlowLogsTableCreateCompanionBuilder,
          $$CashFlowLogsTableUpdateCompanionBuilder,
          (
            CashFlowLog,
            BaseReferences<_$AppDatabase, $CashFlowLogsTable, CashFlowLog>,
          ),
          CashFlowLog,
          PrefetchHooks Function()
        > {
  $$CashFlowLogsTableTableManager(_$AppDatabase db, $CashFlowLogsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CashFlowLogsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CashFlowLogsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CashFlowLogsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
typedef $$CashFlowLogsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CashFlowLogsTable,
      CashFlowLog,
...
class $AppDatabaseManager {
  ...
  $$CashFlowLogsTableTableManager get cashFlowLogs =>
      $$CashFlowLogsTableTableManager(_db, _db.cashFlowLogs);
}
